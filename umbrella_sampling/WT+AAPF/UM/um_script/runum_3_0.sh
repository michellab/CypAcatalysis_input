...
PRINT STRIDE=10 ARG=omega,omega2,restraint-omega.bias,d1,d2,d3,d4 FILE=COLDISTK300$AT

EOF


#mdrun_mpi -plumed plumed.dat -nsteps 3500000 -x trajK800$AT.xtc -gpu_id 0
mdrun_mpi -ntomp 8 -plumed plumed.dat -nsteps 3500000 -x trajK300$AT.xtc -gpu_id 1 -pin on -pinoffset 0
