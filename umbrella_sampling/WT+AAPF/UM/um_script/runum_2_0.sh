...
PRINT STRIDE=10 ARG=omega,omega2,restraint-omega.bias,d1,d2,d3,d4 FILE=COLDISTK600$AT

EOF


#mdrun_mpi -plumed plumed.dat -nsteps 3500000 -x trajK800$AT.xtc -gpu_id 0
mdrun_mpi -ntomp 2 -plumed plumed.dat -nsteps 3500000 -x trajK600$AT.xtc -gpu_id 0 -pin off -pinoffset 2
